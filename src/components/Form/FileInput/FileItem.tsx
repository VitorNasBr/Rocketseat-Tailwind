    ...
    variants: {
        state: {
            ...
            error: {
                ...
                deleteButton: 'text-error-700 hover:text-error-700 dark:text-error-400 dark:hover:text-error-300'
            },
        }
    },
            ...
            {state === 'error' ? (
                ...
                <div className="flex flex-1 flex-col items-start gap-1">
                    <div className="flex flex-col">
                        ...
                        <span className="text-sm font-medium text-zinc-500 dark:text-zinc-400">{formatBytes(size)}</span>
                    </div>
